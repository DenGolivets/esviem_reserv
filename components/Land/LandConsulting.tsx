            ...
            <div className=" rounded-3xl p-8 md:p-12 text-white shadow-2xl overflow-hidden relative">
              ...
              <div className="relative z-10 text-center">
                ...
                <p className="text-lg md:text-xl opacity-90 mb-6">
                  Дізнайтесь більше про наші послуги в галузі земельних відносин
                </p>
        ...
        {isModalOpen && (
          ...
          >
            <motion.div
              ...
              className="bg-gradient-to-br from-slate-800 to-slate-700 rounded-3xl p-8 max-w-2xl w-full max-h-[80vh] overflow-y-auto border border-[var(--hero-gold)]/50 shadow-2xl"

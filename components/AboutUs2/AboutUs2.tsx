      ...
      <div className="relative w-full h-full min-h-screen">
        <div className="container mx-auto px-4 py-4 relative z-10">
          ...
          >
            ...
            >
              {i18n._("ESVIEM — це професійна команда спеціалістів з понад 15-річним досвідом роботи у сферах юридичного, фінансового, будівельного та земельного консультування. Ми спеціалізуємось на вирішенні найскладніших завдань для бізнесу та приватних клієнтів, надаючи комплексні рішення та індивідуальний підхід до кожного проєкту. Наша місія — забезпечити клієнтам впевненість у прийнятті стратегічних рішень завдяки експертним знанням та набутому досвіду")}
            </motion.p>
          </motion.div>

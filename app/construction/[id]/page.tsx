...
export default function ConstructionDetailPage() {
  ...
  },
  {
    ...
    detailedDescription: i18n._("Завдання на проєктування - це вимоги замовника до планувальних, архітектурних, інженерних і технологічних рішень об'єкта будівництва та його основних параметрів.\n\nЕтапи складання завдання на проєктування:\n\n1. Збір вихідних даних\n2. Аналіз вихідних даних та формування завдання на проєктування\n\nТермін виконання: від 10 робочих днів."),
  },
  {
  ...
  },
  {
    ...
    detailedDescription: i18n._("Містобудівні умови і обмеження (МУО) – це документ, що містить комплекс планувальних та архітектурних вимог до проєктування і будівництва і є одним із складових вихідних даних для проєктування.\n\nЕтапи отримання МУО:\n\n1. Підготовка та формування заявки\n2. Технічний супровід при отриманні містобудівних умов і обмежень\n\nТермін виконання: від 15 робочих днів."),
  },
  {
